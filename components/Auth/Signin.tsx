          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSignIn}>
                ...
                {error && (
                  <div className="mb-4 rounded-lg bg-danger opacity-75 border-2 border-danger flex items-center justify-between">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M17.0001 1.00008L1.00012 17.0001"
                          stroke="white"
                          strokeWidth="2"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M1.00012 1.00008L17.0001 17.0001"
                          stroke="white"
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
