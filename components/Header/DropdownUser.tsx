...
const DropdownUser = () => {
  ...
  const user: UserType = useSelector((state) => state.authReducer.user);
    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs">{ user?.profile?.role }</span>
        </span>
        ...
        <span className="h-12 w-12 rounded-full">
          <Image
            ...
            src={user?.profile?.avatar || `https://ui-avatars.com/api/?background=random&name=${user?.firstName}+${user?.lastName}`}
            alt="User"
          />
        </span>
